...
class S {
  ...
  /// `This project is a purely local live streaming application. We do not collect user information. The application directly requests the live streaming platform's official interface. All data is stored locally on the user's device, with optional WebDAV synchronization.`
