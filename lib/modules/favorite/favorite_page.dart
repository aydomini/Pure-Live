                      ...
                      itemBuilder: (BuildContext context) {
                        return [
                          PopupMenuItem(
                            ...
                            child: MenuListTile(leading: const Icon(CustomIcons.search), text: S.of(context).search_live),
                          ),
                          PopupMenuItem(
                            value: 1,
                            padding: const EdgeInsets.symmetric(horizontal: 12),
                            child: MenuListTile(leading: const Icon(Icons.link), text: S.of(context).link_access),
                          ),
                        ];
                      },
                    ),
